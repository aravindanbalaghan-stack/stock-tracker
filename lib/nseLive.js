...
// NSE trading session in IST minutes-from-midnight.
...
/**
 * How far through the trading session we are, 0-1. Used to project a
 * full-day volume from partial volume, and to tell the user how complete
 * the live picture is. Weekends/holidays aren't detected here — that's
 * handled by whether a live snapshot comes back with real volume at all.
 */
