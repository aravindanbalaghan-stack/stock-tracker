...
//   - Outcome: from the signal's bar forward, up to HORIZON_DAYS trading
//     days. A WIN is a forward bar whose HIGH reaches entry price *
//     (1 + TARGET_PCT/100) before any forward bar's LOW touches entry
//     price * (1 - STOP_PCT/100). A LOSS is the reverse ordering. A signal
//     with fewer than HORIZON_DAYS of bars remaining after it (too recent
//     to have played out) is excluded from the probability, not counted
//     as a loss.
